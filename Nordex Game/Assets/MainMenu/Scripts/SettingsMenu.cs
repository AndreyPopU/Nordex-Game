...
public class SettingsMenu : MonoBehaviour
{
    ...
    public void FindResolution(bool saved)
    {
        ...
        for (int i = 0; i < resolutions.Length; i++)
        {
            ...
            print(resolutions[i].refreshRate);
    ...
    {
        SaveLoadManager.SaveSettings(SaveLoadManager.BoolToInt(isFullscreen),
    ...
    {
        if (isFullscreen) { isFullscreen = false; fullscreenText.color = Color.white; }
        else { isFullscreen = true; fullscreenText.color = activeColor; }
